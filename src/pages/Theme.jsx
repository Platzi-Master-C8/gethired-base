        ...
        <AccordionDetails>
          <div className="content">
            ...
            <Typography variant="body1" fontFamily="Montserrat">
              body1.(Montserrat) Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quos
            ...
            <Typography variant="body2" fontFamily="Montserrat">
              body2.(Montserrat) Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quos
              blanditiis tenetur unde suscipit, quam beatae rerum inventore consectetur, neque
              doloribus, cupiditate numquam dignissimos laborum fugiat deleniti? Eum quasi quidem
              quibusdam.
            </Typography>
